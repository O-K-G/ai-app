...
export default function Home() {
  return (
    <AssistantContextProvider>
      <main>
        <Faq />
        <div className="bg-radial-gradient flex flex-col items-center justify-between size-full lg:w-1/2 lg:mx-auto min-h-screen max-h-screen overflow-hidden p-4">
